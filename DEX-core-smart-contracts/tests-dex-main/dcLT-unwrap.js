...
if (networkSelector == 2) {
  ...
  const valueWTON = 10_000_000_000;
  ...
  async function main(client) {
    ...
    for (const item of resultArr) {
      ...
      responce = await clientAcc.run("sendTokens", {
        tokenRoot:rootWTONAddr,
        to:vaultWTONAddr,
        tokens:valueWTON,
        grams:1_200_000_000,
      });
      console.log("Contract reacted to your sendTokens for unwrap:", responce.decoded.output);
