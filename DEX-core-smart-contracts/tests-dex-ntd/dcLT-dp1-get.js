...
async function main(client) {
  ...
  // let clientAddrAnzor = '0:fc26b703964ae37e63009631bbfae15f7580c582cd961b789e1109c3680f91c3';
  const clientAcc = new Account(DEXClientContract, {address:clientAddr,signer:clientKeys,client,});
  // const clientAcc = new Account(DEXClientContract, {address:clientAddrAnzor,signer:clientKeys,client,});
  response = await clientAcc.runLocal("rootWallet", {});
  // console.log("Client walletRoot:", response.decoded.output);
  // response = await clientAcc.runLocal("rootConnector", {});
  // console.log("Client rootConnector:", response.decoded.output);
